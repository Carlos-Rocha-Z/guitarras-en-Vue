...
<template lang="">
  <div class="col-md-6 col-lg-4 my-4 row align-items-center">
    ...
    <div class="col-8">
      ...
      <!-- v-on:click="numero++" es lo mismo que : v-on:click="incrementar" y esto es lo mismo que :@click="incrementar"  
      Funcionaba bien cuando se encontraba la función dentro del mismo archivo -->
      <button
        type="button"
